...
lb-run --siteroot=/cvmfs/lhcb.cern.ch/lib/ -c x86_64_v2-centos7-gcc11-opt --use=AppConfig.v3r460 --use=Gen/DecFiles.v32r41 --use=ProdConf Gauss/v56r11 gaudirun.py -T '$APPCONFIGOPTS/Gauss/Beam6800GeV-mu100-2024.W31-nu6.3.py' '$APPCONFIGOPTS/Gauss/EnableSpillover-25ns.py' '$APPCONFIGOPTS/Gauss/Run3-detector.py' '$APPCONFIGOPTS/Gauss/DataType-2024.py' $DECFILESROOT_custom/options/42912041.py '$LBPYTHIA8ROOT/options/Pythia8.py' '$APPCONFIGOPTS/Gauss/G4PL_FTFP_BERT_EmOpt2.py' '$APPCONFIGOPTS/Persistency/BasketSize-10.py' '$APPCONFIGOPTS/Persistency/Compression-ZSTD-1.py' prodConf_00012345_00006789_1.py

#lb-run --siteroot=/cvmfs/lhcb.cern.ch/lib/ -c x86_64_v2-centos7-gcc11-opt --use=AppConfig.v3r460 --use=Gen/DecFiles.v32r41 --use=ProdConf Gauss/v56r11 gaudirun.py -T '$APPCONFIGOPTS/Gauss/Beam6800GeV-mu100-2024.W31-nu6.3.py' '$APPCONFIGOPTS/Gauss/EnableSpillover-25ns.py' '$APPCONFIGOPTS/Gauss/Run3-detector.py' '$APPCONFIGOPTS/Gauss/DataType-2024.py' $DECFILESROOT_custom/options/42912041.py '$LBBCVEGPYROOT/options/BcVegPyPythia8.py' '$APPCONFIGOPTS/Gauss/G4PL_FTFP_BERT_EmOpt2.py' '$APPCONFIGOPTS/Persistency/BasketSize-10.py' '$APPCONFIGOPTS/Persistency/Compression-ZSTD-1.py' prodConf_00012345_00006789_1.py
