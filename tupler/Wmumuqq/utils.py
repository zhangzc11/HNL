...
def make_comb_mass(nC=1):
    ...
    E2 = F.VALUE_OR(0) @ F.CHILD(2, F.VALUE_OR(0) @ F.CHILD(nC, F.VALUE_OR(0) @ F.ENERGY))
    Px2 = F.VALUE_OR(0) @ F.CHILD(2, F.VALUE_OR(0) @ F.CHILD(nC, F.VALUE_OR(0) @ F.PX))
    Py2 = F.VALUE_OR(0) @ F.CHILD(2, F.VALUE_OR(0) @ F.CHILD(nC, F.VALUE_OR(0) @ F.PY))
    Pz2 = F.VALUE_OR(0) @ F.CHILD(2, F.VALUE_OR(0) @ F.CHILD(nC, F.VALUE_OR(0) @ F.PZ))
    return  F.VALUE_OR(0) @ fmath.sqrt( (E1+E2)*(E1+E2) - (Px1+Px2)*(Px1+Px2) - (Py1+Py2)*(Py1+Py2) - (Pz1+Pz2) * (Pz1+Pz2) ) 


def make_WR_comb_vars():
    return FunctorCollection({
        "MmuWmuN": make_comb_mass(1),
...
def make_jets(name="SimpleJets_{hash}", pt_min=10 * GeV, JetsByVtx=False, useMC=False):
    ...
    code = F.require_all(
        ...
        F.CHARGE > -99, F.MASS > -1, F.PARTICLE_ID != 0,
    )
...
def JetConstituents(data__, MCTRUTH):
    ...
    if MCTRUTH is not None:
        var_const += FunctorCollection({
            ...
            "ConTRUEID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.PARTICLE_ID)) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_MOTHER_ID": F.MAP( F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(1, F.PARTICLE_ID)) ) @ F.GET_GENERATION(1),
            "ConMC_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(1, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            ...
            "ConMC_GD_MOTHER_ID_N9900024": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(2, F.PARTICLE_ID))) == 9900024) @ F.GET_GENERATION(1),
            "ConMC_GD2_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(2, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GD3_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(3, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GD4_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(4, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GD5_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(5, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GD6_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(6, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GD7_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(7, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GD8_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(8, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GD9_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(9, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GD10_MOTHER_ID_N9900014": F.COUNT_IF( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(10, F.PARTICLE_ID))) == 9900014) @ F.GET_GENERATION(1),
            "ConMC_GDall_MOTHER_ID_N9900014": F.COUNT_IF( 
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(1, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(2, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(3, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(4, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(5, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(6, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(7, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(8, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(9, F.PARTICLE_ID))) == 9900014 ) |
            ( fmath.abs(F.VALUE_OR(0) @ MCTRUTH(F.MC_MOTHER(10, F.PARTICLE_ID))) == 9900014 )
            ) @ F.GET_GENERATION(1),
...
def make_jet_vars(data_, mctruth_, is_simulation=False):
    ...
    jet_functors += FC.ParticleID()
    #jet_functors += FC.NeutralCaloInfo(extra_info=True)
    #jet_functors += FC.ChargedCaloInfo(extra_info=False)
